...
const DataItem1: React.FC<any> = () => {
  return (
    <div className="dataitem dataitem1 flex justify-between mt-3 cursor-pointer">
      ...
      <div className="w-full flex flex-col justify-center pl-3">
        <div className="text-xs" style={{ color: '#7F8792' }}>PoAP Mint Count</div>
        <div className="text-sm font-bold mt-1" style={{ color: '#3F4664' }}>25</div>
      </div>
    </div>
  )
